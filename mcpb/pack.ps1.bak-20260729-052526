...
Remove-Item -Path (Join-Path $mcpbDir "src\limx_robotics_mcp.egg-info") -Recurse -Force -ErrorAction SilentlyContinue
...
$bundleName = "limx-robotics-mcp-v$version.mcpb"
