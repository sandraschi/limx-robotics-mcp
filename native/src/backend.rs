...
const BACKEND_NAME: &str = "limx-robotics-mcp-backend.exe";
const BACKEND_PORT: u16 = 11044;
const BACKEND_TAG: &str = "limx-robotics-mcp-backend-x86_64-pc-windows-msvc.exe";
const ENV_PORT: &str = "PORT";
const ENV_HOST: &str = "HOST";
const ENV_TAURI: &str = "LIMX_ROBOTICS_MCP_TAURI";
