...
export default function Settings() {
	...
	const editableKeys = ["LIMX_EXTERNAL_DIR", "LIMX_LOG_DIR", "LIMX_SIM_PYTHON"];

	const providerModels =
		providers[selectedProvider] || providers["ollama"] || [];
		...
		<div className="p-6 space-y-6">
			...
			<div className="bg-white rounded-lg shadow-sm border border-slate-200 p-5 space-y-4">
				...
				<div className="flex items-center gap-3">
					...
					{testResult && (
						<span
							className={`text-xs ${testResult === "Connected" ? "text-green-600" : "text-yellow-600"}`}
						>
							{testResult}
						</span>
					)}
